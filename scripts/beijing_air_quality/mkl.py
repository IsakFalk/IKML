...
if __name__ == "__main__":
    ...
    parser.add_argument("--geom_start", type=float, default=1e-6)
    parser.add_argument("--geom_end", type=float, default=1)
    parser.add_argument("--geom_steps", type=int, default=10)
